...
- **TTNN**: Library of kernels implementing common Machine Learning operations (see https://firdovsimammedovk.github.io/tt-metal/ttnn/)
...
- **API Reference**: https://firdovsimammedovk.github.io/tt-metal/tt-metalium/tt_metal/apis/
...
- **Documentation**: https://firdovsimammedovk.github.io/tenstorrent/
...
**For ML Developers**
    Use the higher-level `TT-NN <https://firdovsimammedovk.github.io/tt-metal/ttnn/>`_ API for model development and deployment. TT-NN builds on TT-Metalium but provides PyTorch-like operations and automatic kernel selection.
